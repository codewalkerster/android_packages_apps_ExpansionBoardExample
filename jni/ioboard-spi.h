...
extern int ioboard_spi_write(
        struct spi_device *spi, unsigned int addr, unsigned char *wdata, unsigned int size);
extern int ioboard_spi_read(
        struct spi_device *spi, unsigned int addr, unsigned char *rdata, unsigned int size);
//[*]--------------------------------------------------------------------------------------------------[*]
